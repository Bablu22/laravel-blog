    ...
    <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        ...
        @auth
            <div class="flex-row my-3 my-md-0">
                <a href="#" class="text-white mr-3 header-search-icon" title="Search" data-toggle="tooltip"
                ...
                <a href="{{route('profile',auth()->user()->username)}}" class="mr-3">
                    <img title="My Profile" data-toggle="tooltip" data-placement="bottom"
                         style="width: 32px; height: 32px; border-radius: 16px"
                         src="{{auth()->user()->avatar}}" alt="avatar"/>
                </a>
                <a class="btn btn-sm btn-success mr-3" href="{{route('post.create')}}">Create Post</a>
